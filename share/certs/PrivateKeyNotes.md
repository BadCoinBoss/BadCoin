...
unlocked to sign the BadCoind-Qt.app bundle.
...
allowing somebody to distribute a BadCoind-Qt.app or BadCoind-Qt-setup.exe with a valid
...
that the BadCoind-Qt.exe file inside the installer had not been tampered with.
