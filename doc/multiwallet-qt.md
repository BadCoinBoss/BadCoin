...
In order to support loading of multiple wallets in BadCoind-Qt, a few changes in the UI architecture will be needed.
...
Finally, three new headers and source files will have to be added to BadCoind-Qt.pro.
...
----------------------
bitcoin.cpp is the entry point into BadCoind-Qt, and as such, will require some minor modifications to provide hooks for
