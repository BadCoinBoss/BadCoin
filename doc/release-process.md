...
##perform gitian builds
 ...
 Build BadCoind and BadCoind-Qt on Linux32, Linux64, and Win32:
...
**Perform Mac build:**
  ...
  OSX binaries are created by Gavin Andresen on a 32-bit, OSX 10.6 machine.
	...
	qmake RELEASE=1 USE_UPNP=1 USE_QRCODE=1 BadCoind-Qt.pro
	make
	export QTDIR=/opt/local/share/qt4  # needed to find translations/qt_*.qm files
	T=$(contrib/qt_translations.py $QTDIR/translations src/qt/locale)
	python2.7 share/qt/clean_mac_info_plist.py
	python2.7 contrib/macdeploy/macdeployqtplus BadCoind-Qt.app -add-qt-tr $T -dmg -fancy contrib/macdeploy/fancy.plist

 Build output expected: BadCoind-Qt.dmg

###Next steps:

* Code-sign Windows -setup.exe (in a Windows virtual machine) and
  OSX BadCoind-Qt.app (Note: only Gavin has the code-signing keys currently)
