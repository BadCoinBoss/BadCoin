...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Badcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"hashmebadly.com", "node.hashmebadly.com"},
	{"5.196.10.58", "5.196.10.58"},
	{"82.211.31.107", "82.211.31.107"},
	{"ispace.co.uk", "ispace.co.uk"},
	{"54.194.99.126", "54.194.99.126"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Badcoin is probably already running."), addrBind.ToString().c_str());
        else
